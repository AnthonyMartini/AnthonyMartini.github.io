      ...
      >
        ...
        <div className="flex justify-center order-1 md:order-2 md:col-span-2">
            <div className="relative group w-64 h-64 md:w-80 md:h-80">
                ...
                <div className="relative w-full h-full rounded-full p-1 bg-gradient-to-br from-electric-blue/60 via-white to-indigo-400/50 shadow-2xl transition-transform duration-500 group-hover:scale-105">
                  <img
                    src="/img/pfp.jpg"
